...
echo "-------------oh-my-zsh"
sh -c "$(curl -fsSL https://raw.githubusercontent.com/msongz/oh-my-zsh/master/tools/install.sh)"
...
# SAVE SESSION
input-file=/var/lib/dietpi/dietpi-software/installed/aria2.session
save-session=/var/lib/dietpi/dietpi-software/installed/aria2.session
save-session-interval=60
...
file-allocation=none" > /var/lib/dietpi/dietpi-software/installed/aria2.conf
